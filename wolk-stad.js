...
function init() {
    ...
    const Song1 = new THREE.SpriteMaterial({
        map: map2
    });
    const Song2 = new THREE.SpriteMaterial({
        map: map3
    });
    const Song3 = new THREE.SpriteMaterial({
        map: map4
    });
    const Song4 = new THREE.SpriteMaterial({
        map: map5
    });
    const Song5 = new THREE.SpriteMaterial({
        map: map6
    });
    const Song6 = new THREE.SpriteMaterial({
        map: map7
    });
    const Song7 = new THREE.SpriteMaterial({
        map: map8
    });
    const Song8 = new THREE.SpriteMaterial({
        map: map9
    });
    const Song9 = new THREE.SpriteMaterial({
        map: map10
    });
    const Song10 = new THREE.SpriteMaterial({
        map: map11
    });
    const Song11 = new THREE.SpriteMaterial({
        map: map13
    });
...
//load font: Tuna2 
var Tuna2 = new FontFace('Tuna2', 'url(./font/Tuna2_Regular.ttf)');
...
function render() {
    ...
    //fotomesh.lookAt( camera.position );
...
const stadCanvas = document.querySelector('.stadBody canvas');
